 ...
 * 
 * // create a Student Error Message StudentErrorResponse error = new
 ...
 * handleException(StudentApiException exc) {
 * 
 * // create a Student Error Message StudentErrorResponse error = new
 * StudentErrorResponse();
 * 
 ...
 * ResponseEntity<StudentErrorResponse> handleException(AccessDeniedException
 * exc) {
 * 
 * // create a Student Error Message StudentErrorResponse error = new
 * StudentErrorResponse();
 ...
 * 
 * // create a Student Error Message StudentErrorResponse error = new
 * StudentErrorResponse(); System.out.println("printing error");
 * error.setStatus(HttpStatus.BAD_REQUEST.value());
 * error.setMessage(exc.getClass().getSimpleName()); exc.printStackTrace();
 * error.setTimeStamp(System.currentTimeMillis());
 * 
 * // return ResponseEntity
 * 
 ...
 * 
 * @ExceptionHandler public ResponseEntity<StudentErrorResponse>
 * handleException(NoStudentRecordFoundException exc) {
 * 
 * // create a Student Error Message StudentErrorResponse error = new
 * StudentErrorResponse();
 * 
